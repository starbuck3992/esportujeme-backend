...
class TournamentMatchResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'screenshotHome' => new TournamentScreenshotResource($this->whenLoaded('screenshotHome')),
            'screenshotGuest' => new TournamentScreenshotResource($this->whenLoaded('screenshotGuest'))
        ];
    }
}
